...
class PessoasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post pessoas_url, params: { pessoa: { ano_nascimento: @pessoa.ano_nascimento, nome: @pessoa.nome, sobre: @pessoa.sobre } }
    end
  ...
  test "should update pessoa" do
    patch pessoa_url(@pessoa), params: { pessoa: { ano_nascimento: @pessoa.ano_nascimento, nome: @pessoa.nome, sobre: @pessoa.sobre } }
